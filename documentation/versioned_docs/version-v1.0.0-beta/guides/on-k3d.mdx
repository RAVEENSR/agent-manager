...
```bash
curl -fsSL https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/quick-start/k3d-config.yaml \
...
```bash
kubectl apply -f https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/k8s/coredns-amp-custom.yaml
```
...
helm upgrade --install openbao oci://ghcr.io/openbao/charts/openbao \
  ...
  --create-namespace \
  --version 0.25.6 \
  --values https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/single-cluster/values-openbao.yaml \
  --timeout 180s
...
helm install openchoreo-control-plane \
  ...
  --create-namespace \
  --timeout 600s \
  --values https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/single-cluster/values-cp.yaml
...
helm install openchoreo-data-plane \
  ...
  --create-namespace \
  --timeout 600s \
  --values https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/single-cluster/values-dp.yaml
...
```bash
kubectl apply -f https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/values/oc-collector-configmap.yaml \
...
helm install openchoreo-observability-plane \
  ...
  --create-namespace \
  --timeout 25m \
  --values https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/single-cluster/values-op.yaml
...
```bash
curl -fsSL "https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/scripts/add-environment-thunder.sh" \
...
| File | Purpose |
|------|---------|
| [k3d-config.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/quick-start/k3d-config.yaml) | k3d cluster with all required port mappings |
| [coredns-amp-custom.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/k8s/coredns-amp-custom.yaml) | CoreDNS rewrites for `*.openchoreo.localhost`, `*.amp.localhost`, `*.agentmanager.localhost`, `*.am-gateway.localhost`, `*.gateway.localhost` |
| [add-environment-thunder.sh](https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/scripts/add-environment-thunder.sh) | Provisions the per-environment Thunder identity provider |
| [values-cp.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/single-cluster/values-cp.yaml) | Control Plane — Backstage disabled, AMP Thunder OIDC |
| [values-dp.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/single-cluster/values-dp.yaml) | Data Plane — gateway ports, Fluent Bit config |
| [values-op.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/single-cluster/values-op.yaml) | Observability Plane — standalone OpenSearch, AMP Thunder OIDC |
| [values-openbao.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/single-cluster/values-openbao.yaml) | OpenBao — dev mode, Kubernetes auth, pre-seeded secrets |
| [oc-collector-configmap.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/values/oc-collector-configmap.yaml) | Custom OTel Collector ConfigMap for trace ingestion |
| [wso2-amp-api-platform-gateway-extension](https://github.com/wso2/agent-manager/tree/amp/v1.0.0-beta/deployments/helm-charts/wso2-amp-api-platform-gateway-extension) | API Platform Gateway Helm chart (includes gateway config, bootstrap, CR) |
| [otel-collector-rest-api.yaml](https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/values/otel-collector-rest-api.yaml) | OTel Collector REST API resource |
