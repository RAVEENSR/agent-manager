...
```bash
curl -fsSL https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/setup/install-gvisor.sh \
  | sudo bash
```
...
kubectl apply -f https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/k8s/gvisor-runtimeclass.yaml
...
```bash
curl -fsSL https://raw.githubusercontent.com/wso2/agent-manager/amp/v1.0.0-beta/deployments/scripts/add-environment.sh \
